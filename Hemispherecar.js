	...
	//	scene.add(cone4);
     ...
     //   scene.add(bodycube1);
       ...
       // scene.add(bodycube3);
		...
		lights = new THREE.SpotLight(0xe22e2e);
		lights.position.set(1000,4000,4000);
		scene.add(lights);
		lights.castShadow = true;

		
		lights1 = new THREE.SpotLight(0x2e2ee2);
		lights1.position.set(-4000,-1000,-2000);
		scene.add(lights1);
			
		lights3  = new THREE.DirectionalLight(0x69a77c,1,2000);
		lights3.position.set(4000,0,-2000);
		scene.add(lights3);
		...
		//lights = new THREE.HemisphereLight(0x0900de, 0xe85252, 100);
//scene.add( lights );


		scene.add(group);
	scene.background = new THREE.Color( 0x445052 );
